...
async def carousel_move(pose, torque = 0.5, speed = 1.0, pos_threshold = 10, overload_threshold = 10):
    old_pos = 0
    overload_count = 0
...
async def eject_left():
    ...
    await servos.moveMultiple({'ejecteur_gauche': ejecteur_gauche_arriere}, speed=0.6)
...
async def eject_center():
    ...
    await servos.moveMultiple({'ejecteur_centre' : ejecteur_centre_max}, speed=0.2)
...
async def eject_right():
    ...
    await servos.moveMultiple({'ejecteur_droit' : ejecteur_droit_arriere}, speed=0.6)
