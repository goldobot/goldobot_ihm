...
async def construction_gateau_haut_vert():
    ...
    await asyncio.sleep(0.2)
    await goldo_lift_move(GoldoLift.Right, 450)
    await right_pump_on()
    await asyncio.sleep(0.2)
...
async def construction_gateau_haut_bleu():
    ...
    await asyncio.sleep(0.2)
    await goldo_lift_move(GoldoLift.Left, 450)
    await left_pump_on()
    await asyncio.sleep(0.2)

    # depose rose
    await goldo_lift_move(GoldoLift.Left, 550)
...
async def construction_gateau_milieu_bleu():
    ...
    await servos.moveMultiple(bras_gauche_prise_rose, 1)
    await asyncio.sleep(0.2)
    await goldo_lift_move(GoldoLift.Left, 220)
    await left_pump_on()
    await asyncio.sleep(0.2)
