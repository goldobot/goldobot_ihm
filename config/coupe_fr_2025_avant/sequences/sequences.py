...
async def prematch():
    ...
    await actuators_back.bras_standby()
    await asyncio.sleep(2)
    await actuators_back.ascenseur_up()

    # Placement
    await recalages.recalage()

    await asyncio.sleep(1)
    await actuators_back.ascenseur_down()
    await asyncio.sleep(1)
    await actuators_back.bras_up()
    await actuators_back.soulageur_down()
...
async def action1():
    ...
    await actuators_back.bras_standby()
    await actuators_back.ventouses_ext_attrape()
    await actuators_back.ventouses_int_attrape()
    ...
    try:
        ...
        await propulsion.translation(0.13, 0.2)
    await asyncio.sleep(0.2)
    #await actuators_dyna.ascenseur_av_soulage()
    #await asyncio.sleep(0.2)
    await asyncio.sleep(global_debug_action_timeout)

    # verrouillage planches
    await actuators_back.soulageur_av_up()
    await actuators_back.bras_av_prise_hard()
    await asyncio.sleep(0.2)
    await actuators_back.pump_av_on()
    await asyncio.sleep(0.2)
    await actuators_back.bras_av_transport()
    await asyncio.sleep(0.2)
    await actuators_back.soulageur_av_transport()
    await asyncio.sleep(0.2)
    await asyncio.sleep(global_debug_action_timeout)

    await propulsion.faceDirection(0, global_turn_speed_slow)
    await propulsion.moveToRetry(poses.Act1_prise_2, global_long_speed)
    await propulsion.faceDirection(0, global_turn_speed_slow)
    ...
    await asyncio.sleep(0.2)
    await actuators_back.bras_prise_hard()
    await asyncio.sleep(0.2)
    await actuators_back.pump_on()
    await asyncio.sleep(0.2)
    await actuators_back.bras_transport()
    await asyncio.sleep(0.2)
    await actuators_back.soulageur_transport()
    await asyncio.sleep(0.2)
    try:
        ...
        await propulsion.translation(0.20, 0.15)
    await asyncio.sleep(0.2)
    await actuators_back.ascenseur_soulage()
    await asyncio.sleep(0.2)
    ...
    await propulsion.faceDirection(0)
    await propulsion.translation(0.03, 0.15)

    await actuators_back.soulageur_av_down()
    await actuators_back.bras_av_up()
    await actuators_back.ventouses_av_ext_lache()
    await asyncio.sleep(0.2)
...
async def action4():
    ...
    await actuators_back.ascenseur_down()
    await asyncio.sleep(0.5)
    await actuators_back.ascenseur_disable()
...
async def action1_ZoneDL():
    ...
    # verrouillage planches
    await actuators_back.soulageur_up()
    await actuators_back.bras_prise_hard()
    await asyncio.sleep(0.2)
    await actuators_back.pump_on()
    await asyncio.sleep(0.2)
...
async def match_start_ZoneDA():
    ...
    if not stop_actions:
        ...
        try:
            ...
            print ("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
            await actuators_back.ascenseur_soulage()
            await actuators_back.ventouses_ext_lache()
            await actuators_back.ventouses_int_lache()
            stop_actions = True
        await asyncio.sleep(0.5)
    else:
        print ("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
...
async def construction_goldo():
    ...
    await actuators_back.ecarteur_on()
    await asyncio.sleep(short_timeout)
    await actuators_back.bras_standby()
    await asyncio.sleep(short_timeout)
    await actuators_back.ventouses_int_lache()
    ...
    await asyncio.sleep(short_timeout)
    await actuators_back.ecarteur_off()
    await asyncio.sleep(short_timeout)
    await asyncio.sleep(long_timeout)

    print ("Construction niveau 2")
    await actuators_back.soulageur_mid()
    await actuators_back.ascenseur_stage2_high()
    await asyncio.sleep(long_timeout)
    await propulsion.translation(-0.13, 0.15)
    await asyncio.sleep(short_timeout)
    await actuators_back.bras_prise()
    await asyncio.sleep(short_timeout)
    await actuators_back.ascenseur_stage2_depose()
    await asyncio.sleep(short_timeout)
    await actuators_back.pump_off()
    await asyncio.sleep(short_timeout)
    await actuators_back.ventouses_ext_lache()
    ...
    await actuators_back.soulageur_down()
    await asyncio.sleep(short_timeout)
    await actuators_back.ascenseur_standby()
    await asyncio.sleep(short_timeout)
