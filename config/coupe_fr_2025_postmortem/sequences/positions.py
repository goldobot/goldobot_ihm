...
class YellowPoses:
    ...
    Act1_predepose     = (  1.650, -0.220, 180)
    ...
    Act2_preprise      = (  1.470, -0.725, 180)
    Act2_predepose     = (  1.640, -0.725, 180)
    ...
    # Action3.5
    Act3_5_preprise    = (  0.675, -1.175, 90)
    Act3_5_predepose   = (  1.220, -0.250, 180)
    Act3_5_depose      = (  1.420, -0.250, 180)
    ...
    Act4_traj1_finish  = (  0.800, -1.20, -90)
    Act4_depose        = (  0.400, -1.20, 180)
    Act4_final         = (  0.500, -1.20, 180)

    zone_dl_band = (1.7, 1.15, 180)
    ...
    Act3_ZoneDL_predepose     = (  1.650,  1.250, 180)
...
class BluePoses:
    ...
    # Action3.5
    Act3_5_preprise    = symetrie(YellowPoses.Act3_5_preprise)
    Act3_5_predepose   = symetrie(YellowPoses.Act3_5_predepose)
    Act3_5_depose      = symetrie(YellowPoses.Act3_5_depose)
    ...
    Act4_depose        = symetrie(YellowPoses.Act4_depose)
    Act4_final         = symetrie(YellowPoses.Act4_final)

    zone_dl_band = symetrie(YellowPoses.zone_dl_band)
