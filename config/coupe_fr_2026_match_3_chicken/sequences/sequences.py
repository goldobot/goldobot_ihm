...
async def action_0():
    ...
    await propulsion.moveToRetry(poses.First_grab_wp1, 0.3)
    await asyncio.sleep(global_short_sleep)
    ...
    # FIXME : DEBUG
    actuators.set_global_grab_height(120)
    if robot.side == 1: # YELLOW
        actuators.set_global_grab_x_bias(0)
    elif robot.side == 2: # BLUE
        actuators.set_global_grab_x_bias(-50)
    else:
        raise RuntimeError('Side not set')
    ...
    # FIXME : DEBUG
    actuators.set_global_grab_height(180)
    actuators.set_global_grab_x_bias(0)

@robot.sequence
async def action_thermo():
    global poses
    global start_long_speed
    global start_turn_speed
    global global_long_speed
    ...
    #await asyncio.sleep(global_short_sleep)
    #await propulsion.moveToRetry(poses.Inter_wp1, global_long_speed)
    #await asyncio.sleep(global_short_sleep)

    #await propulsion.pointTo(poses.Inter_wp2, global_turn_speed)
    #await asyncio.sleep(global_short_sleep)
    #await propulsion.moveToRetry(poses.Inter_wp2, global_long_speed)
    #await asyncio.sleep(global_short_sleep)
    ...
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Corner_wp, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    ...
    await propulsion.moveToRetry(poses.Border_wp1, global_long_speed)
    await asyncio.sleep(global_short_sleep)
...
async def action_1():
    ...
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Action1_grab_wp1, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    ...
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Action1_drop_wp1, global_long_speed)
    await asyncio.sleep(global_short_sleep)
...
async def action_2():
    ...
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Action2_grab_wp0, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    await propulsion.faceDirection(poses.Action2_grab_wp1[2], global_turn_speed)
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Action2_grab_wp1, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    ...
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Action2_drop_wp1, global_long_speed)
    await asyncio.sleep(global_short_sleep)
...
@robot.sequence
async def action_42(grab_wp0=None, grab_wp1=None, drop_wp0=None, drop_wp1=None):
    global poses
    global start_long_speed
    global start_turn_speed
    global global_long_speed
    ...
    if grab_wp0==None:
        grab_wp0=poses.Action42_grab_wp0
    if grab_wp1==None:
        grab_wp1=poses.Action42_grab_wp1
    if drop_wp0==None:
        drop_wp0=poses.Action42_drop_wp0
    if drop_wp1==None:
        drop_wp1=poses.Action42_drop_wp1
    ...
    await propulsion.pointTo(pt=grab_wp0, yaw_rate=global_turn_speed, back=False)
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(grab_wp0, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    await propulsion.faceDirection(grab_wp1[2], global_turn_speed)
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(grab_wp1, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    ...
    await propulsion.pointTo(pt=drop_wp0, yaw_rate=global_turn_speed, back=True)
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(drop_wp0, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    await propulsion.pointTo(pt=drop_wp1, yaw_rate=global_turn_speed, back=False)
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(drop_wp1, global_long_speed)
    await asyncio.sleep(global_short_sleep)

    if grab_ok:
        await propulsion.faceDirection(drop_wp1[2], global_turn_speed)
        await asyncio.sleep(global_short_sleep)
        await do_drop_y_42()
...
async def action_3():
    ...
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Action3_grab_wp0, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    await propulsion.faceDirection(poses.Action3_grab_wp1[2], global_turn_speed)
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Action3_grab_wp1, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    ...
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Action3_drop_wp1, global_long_speed)
    await asyncio.sleep(global_short_sleep)
...
async def do_push_0000():
    await propulsion.moveToRetry(poses.First_push, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.First_grab_wp2, global_long_speed)
    await asyncio.sleep(global_short_sleep)

async def do_first_drop():
    #await propulsion.pointTo(pt=poses.First_return_wp, yaw_rate=global_turn_speed, back=True)
    #await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.First_return_wp, global_long_speed)
    await asyncio.sleep(global_short_sleep)
...
async def do_grab_and_push_x_0011():
    #await propulsion.moveToRetry(poses.First_grab_wp1, global_long_speed)
    await asyncio.sleep(global_short_sleep)
...
async def do_grab_and_push_x_0101():
    ...
    await actuators.test_grab_right()
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.First_grab_wp3, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    await actuators.test_grab_left()
    await asyncio.sleep(global_short_sleep)
...
async def test_goto_inter_test_wp():
    ...
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Inter_wp0, global_long_speed)
    await asyncio.sleep(global_short_sleep)
    #await propulsion.pointTo(poses.Inter_wp1, global_turn_speed)
    #await asyncio.sleep(global_short_sleep)
    #await propulsion.moveToRetry(poses.Inter_wp1, global_long_speed)
    ...
    await asyncio.sleep(global_short_sleep)
    await propulsion.moveToRetry(poses.Inter_test_wp, global_long_speed)
    await asyncio.sleep(global_short_sleep)
