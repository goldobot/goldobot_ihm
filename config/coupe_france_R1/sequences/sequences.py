...
async def start_match():
    ...
    if jaune_1 == True and five_secs_limit == False:
        await propulsion.pointTo(poses.prise_j1, 1.5)
        await propulsion.moveToRetry(poses.prise_j1, 1.0)
        await actuators.arms_centering()
        await propulsion.pointTo(poses.depose_j_1, 1.5)
    ...
    if jaune_2 and rose_2:
        await propulsion.pointTo(0.3, poses.rose_2[1], 1.5)
        await propulsion.pointTo(poses.jr_1[1], 1.5)
