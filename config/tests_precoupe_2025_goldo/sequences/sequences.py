...
# FIXME : DEBUG
    ...
    # Ascenseur bas
    await actuators_dyna.test_ascenseur_bas()
...
async def action1():
    ...
    # depose baniere
    await propulsion.reposition(-0.05, 0.2)
    ...
    # prise1
    #await actuators_pneuma.ventouses_on()
    await asyncio.sleep(global_debug_action_timeout)
    ...
    await asyncio.sleep(global_debug_action_timeout)
    #await actuators_pneuma.ventouses_off()
    await asyncio.sleep(8.0)
    await asyncio.sleep(global_debug_action_timeout)
    await propulsion.translation(0.08, 0.2)
    await asyncio.sleep(global_debug_action_timeout)
...
async def action3():
    ...
    await asyncio.sleep(0.2)
    await propulsion.translation(-0.105, 0.2)
    await asyncio.sleep(global_debug_action_timeout)
    await propulsion.translation(0.105, 0.2)
    await asyncio.sleep(global_debug_action_timeout)
