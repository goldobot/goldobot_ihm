...
from messages import AdversaryTelemetry
...
class ZmqClient(QObject):
    ...
    adversary_telemetry = pyqtSignal(object)
    ...
    def _on_message_received(self, msg):
        ...
        if msg_type == message_types.AdversaryTelemetry:
            adversary = PropulsionTelemetry(msg[2:])
            self.adversary_telemetry.emit(adversary)
