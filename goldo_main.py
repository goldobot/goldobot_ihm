...
from propulsion_controller_config import PropulsionControllerConfigDialog
from test_propulsion import PropulsionTestDialog
...
class MainWindow(QMainWindow):
    def __init__(self, parent = None):
        ...
        # Create actions
        self._action_open_odometry_config = QAction("Configure Odometry",self)
        self._action_open_propulsion_controller_config = QAction("Configure Propulsion controller",self)
        self._action_propulsion_test = QAction("Test propulsion",self)
...
if __name__ == '__main__':
    ...
    # gapp.setAttribute(Qt.AA_EnableHighDpiScaling)
